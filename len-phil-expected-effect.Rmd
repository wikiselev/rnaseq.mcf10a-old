...
Now consider 136 genes from the green segment. Plot them first:
...
```{r, echo=FALSE, cache=TRUE, fig.width=6, fig.height=3, fig.align='center'}
...
Plot genes in the first cluster:
...
Plot genes in the second cluster:
