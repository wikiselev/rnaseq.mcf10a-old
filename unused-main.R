...
# some other analysis
d.a66 <- combine_gene_sets_motif_targets(list(a66.set1, a66.set2, a66.set3, a66.set4, a66.set5, a66.set6), 20, "a66")
write.csv(d.a66[order(-score)], file = "../pip3-rna-seq-output/rds/wt-targets.csv")
d.mut <- combine_gene_sets_motif_targets(list(set1, set2, set3, set4, set5, set6, set7, set8), 20, "const")
