...
shinyUI(pageWithSidebar(
        ...
        sidebarPanel(
                ...
                checkboxInput("checkbox", label = "Normalize by gene length", value = FALSE),
        ...
        mainPanel(
                ...
                div("\n"),
                "(read counts are normalized by library sizes using estimateSizeFactors() from DESeq2 library)",
                plotOutput('plot')
        )
))